...
public class QuestionCameraScan extends AppCompatActivity implements View.OnClickListener {

    private Uri outputFileUri;
    private View mView;
    public final static String EXTRA_MESSAGE = "com.opetbot.message";
    public static final int REQUEST_ID_MULTIPLE_PERMISSIONS = 1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_question_camera_scan);
    ...
    private boolean checkAndRequestPermissions() {
        ...
        int readexternal_storage = ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE);
        ...
        if (readexternal_storage != PackageManager.PERMISSION_GRANTED) {
